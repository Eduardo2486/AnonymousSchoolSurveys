$(document).ready(function(){
    function editUser(id, text, field){
        ...
        $.ajax({
            method: "POST",
            url: "/cuestionario/core/ajax/update-subject.php",
    ...
    $(".materia, .carrera").keypress(function(e){ 
    ...
    function deleteUser(id, enrollment){
        ...
        $.ajax({
            method: "POST",
            url: "/cuestionario/core/ajax/delete-subject.php",
            data: { id: id }
        })
        .done(function( msg ) {
            if(parseInt(msg) == 1){
